...
function(ct_configure_compiler)
  ...
  if(CT_SANITIZED)
    ...
    elseif(isGCC)
      list(APPEND compilerOptions -fsanitize=alignment,bool,bounds,enum,float-cast-overflow,float-divide-by-zero,integer-divide-by-zero,pointer-overflow,return,shift,signed-integer-overflow,unreachable,vla-bound,vptr,address)
      list(APPEND linkerOptions -fsanitize=alignment,bool,bounds,enum,float-cast-overflow,float-divide-by-zero,integer-divide-by-zero,pointer-overflow,return,shift,signed-integer-overflow,unreachable,vla-bound,vptr,address)
      list(APPEND compilerOptions
              -fno-sanitize-recover=all
              -fno-optimize-sibling-calls
              -fno-omit-frame-pointer
